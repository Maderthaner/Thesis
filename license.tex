...
%
\vspace{7.5cm}
\footnotesize{This document is written in \hologo{LaTeX} and \hologo{BibTeX} using the \hologo{KOMAScript} class. This version was electronically compiled on {\isodate\today} using \hologo{pdfLaTeX} and \hologo{biber}.}\\
%
\null \vspace{1cm}
%
