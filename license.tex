...
%
\vspace{7.5cm}
\footnotesize{This document is written in \hologo{LaTeX} and \hologo{BibTeX}. It was electronically compiled on {\isodate\today} using \hologo{pdfLaTeX} via MiKTeX 2016, TeXnicCenter and SumatraPDF.}\\
%
\null \vspace{1cm}
%
