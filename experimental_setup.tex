...
\end{table}
Different gain modes\index{pnCCD!gain} can be used to be more sensitive to photons at high gain or to store signal from more photons at low gain.
